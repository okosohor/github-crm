...
class ApiService {
  ...
  public async login({ email, password }: { email: string; password: string }): Promise<AxiosResponse<Tokens>> {
  ...
  public async register({ email, password }: { email: string; password: string }): Promise<AxiosResponse<{message: string}>> {
    return this.axiosInstance.post(
  ...
  public async deleteUserProject(projectId: number): Promise<AxiosResponse<number>> {
    return this.axiosInstance.delete(
      `${this.apiUrl}/userProject/delete/${projectId}`,
      {
        ...this.getAxiosConfig(),
        data: { projectId },
      }
  ...
  public async deleteAllUserProjects(): Promise<AxiosResponse<number>> {
    return this.axiosInstance.delete(
      `${this.apiUrl}/userProject/delete`,
      {
        ...this.getAxiosConfig(),
      }
    );
